...
CREATE TABLE "test"."ft2" ("id" int AUTO_INCREMENT(1) PRIMARY KEY, "location" BLOB, "intProperty" int,"doubleProperty" double, "stringProperty" varchar);
CALL AddGeometryColumn('test', 'ft2', 'location', 4326, 'GEOMETRY', 2);
